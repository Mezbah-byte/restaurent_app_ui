...
class _DiscoveryPageState extends State<DiscoveryPage> {
  ...
  List imageRoutesPrice = ['\$5.99', '\$13.50', '\$9.00', '\$14.30'];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          //   child: Image(
          //     image: AssetImage('assets/images/heyo_logo.png'),
          //   ),
          // ),
          actions: <Widget>[
            FlatButton.icon(
            ...
            children: <Widget>[
                                ...
                                child: Ink(
                                  ...
                                  child: InkWell(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Image(
                                        image:
                                            AssetImage(imageIconsRoutes[index]),
                                      ),
                                    ),
                                  ),
                                ),
              ...
              Column(
                ...
                children: imageRoutes
                    .asMap()
                    .entries
                    .map((MapEntry map) => products(map.key))
                    .toList(),
              )
            ],
          ),
